...
from stackteacher import views as teacher_view
...
urlpatterns = [
    ...
    path('tregister/', teacher_view.register, name="register"),
    path('tlogin/', auth_view.LoginView.as_view(template_name="stackusers/login.html"), name='login'),
    path('tlogout/', auth_view.LogoutView.as_view(template_name="stackusers/logout.html"), name='logout'), 

    # Profile system
    path('tprofile/', teacher_view.profile, name="profile"),
    path('tprofile/update/', teacher_view.profile_update, name="profile_update"),
